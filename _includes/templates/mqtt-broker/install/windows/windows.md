...
Використовуючи ці концепції, розробники можуть створювати функціонально незалежні ф'ючери та модулі, що полегшує скальпування, тестування і розширення додатків на Angular.

## third

Модулі: В Angular ф'ючери часто впроваджуються за допомогою модулів. Модуль - це механізм для групування і організації компонентів, сервісів, директив тощо. Його також можна розглядати як ф'ючер модуля, який визначає, як додаток повинен поводитися та як взаємодіяти з іншими частинами додатка.
